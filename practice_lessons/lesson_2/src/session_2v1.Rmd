...
path <- '~/1-2021-22-Projects/Sentiment/coliphi21/'
...
```{r}
## relative path
load('/home/redapemusic35/1-2021-22-Projects/Sentiment/coliphi21/practice_lessons/lesson_2/input/stanford-encyclopedia.RDS')
```
```{r eval=FALSE}
## absolute path
...
```{r eval=FALSE}
## either
sfe <- readtext('~/1-2021-22-Projects/Sentiment/coliphi21/practice_lessons/lesson_2/input/coliphi21_reddit.RDS')
## or
